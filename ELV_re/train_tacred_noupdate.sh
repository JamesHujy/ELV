...
OUTPUT_DIR=./checkpoints/s2s_ft_tacred_noupdate_checkpoints/
...
python main.py \
  ...
  --num_labels 42 --output_dir ${OUTPUT_DIR} --logging_steps 500\
  ...
  --per_gpu_train_batch_size 1 --gradient_accumulation_steps 64 \
  --num_iters 10 --learning_rate 5e-5 --num_warmup_steps 500 --cache_dir ${CACHE_DIR}
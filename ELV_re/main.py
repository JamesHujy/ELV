...
def main():
    ...
    unlabeled_dataset = UnlabledDataset(classifier_tokenizer, generator_tokenizer, args.device)
    unlabeled_dataset.load_init(args.unlabeled_data, label_to_id=args.label_to_id)
    valid_dataset = UnlabledDataset(classifier_tokenizer,  generator_tokenizer, args.device)
    valid_dataset.load_init(args.valid_data, label_to_id=args.label_to_id)
    test_dataset = UnlabledDataset(classifier_tokenizer,  generator_tokenizer, args.device)
    ...
    train(generator, classifier, classifier_tokenizer, generator_tokenizer, unlabeled_dataset, generator_dataset, classifier_dataset, valid_dataset, test_dataset, retriever, args)
